    ...
    <div class="col-md-12">
        <div class="card card-outline card-gray-dark">
            <div class="card-header">
                <h3 class="card-title">Edit Instrumen Akreditasi</h3>
            ...
            <form action="{{ route('update_akreditasi_master', Crypt::encrypt($AkreditasiMasters->id)) }}" method="POST"
                autocomplete="off">
                @csrf
                @method('PUT')
                <div class="card-body">
                            ...
                            <div class="input-group mb-3">
                                <select name="monev_kategori_id"
                                    ...
                                    @foreach ($MonevKategoris as $MonevKategori)
                                        @if ($AkreditasiMasters->monev_kategori_id == $MonevKategori->id)
                        ...
                        <div class="col-sm-2">
                            ...
                            <div class="input-group mb-2">
                                <select name="jenis_dokumen"
                                    ...
                                    data-dropdown-css-class="select2-dark" style="width: 100%;" required>
                                    <option></option>
                                    @if ($AkreditasiMasters->jenis_dokumen == 'LED')
                                        <option value="LED" selected>LED</option>
                                        <option value="LKPT/PS">LKPT/PS</option>
                                    @else
                                        <option value="LED">LED</option>
                                        <option value="LKPT/PS" selected>LKPT/PS</option>
                                    @endif
                                </select>
                                @error('jenis_dokumen')
                                    <div class="invalid-feedback">
                        ...
                        <div class="col-sm-2">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" name="bobot_penilaian" onkeypress="return hanyaAngka(event)"
                                    value="{{ $AkreditasiMasters->bobot_penilaian }}"
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="text" name="elemen"
                                    ...
                                    value="{{ $AkreditasiMasters->elemen }}" placeholder="Sub Elemen">
                                @error('elemen')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="indikator" class="form-control form-control-sm @error('indikator') is-invalid @enderror" id="indikator">{!! $AkreditasiMasters->indikator !!}</textarea>
                        @error('indikator')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="indikator_kinerja"
                            class="form-control form-control-sm @error('indikator_kinerja') is-invalid @enderror" id="indikator_kinerja">{!! $AkreditasiMasters->indikator_kinerja !!}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="dokumen_terkait" class="form-control form-control-sm @error('dokumen_terkait') is-invalid @enderror"
                            id="dokumen_terkait">{!! $AkreditasiMasters->dokumen_terkait !!}</textarea>
