    ...
    <div class="col-md-12">
        <div class="card card-outline card-gray-dark">
            <div class="card-header">
                <h3 class="card-title">Formulir Standar SPMI</h3>
            ...
            <form action="{{ route('standar_detail.store') }}" method="POST" autocomplete="off">
                @csrf
                <div class="card-body">
                        ...
                        <div class="col-sm-2">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input type="number" name="poin"
                                    ...
                                    value="{{ old('poin') }}" placeholder="Poin Standar" required>
                                @error('poin')
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="pernyataan" class="form-control form-control-sm @error('pernyataan') is-invalid @enderror"
                            id="pernyataan">{{ old('pernyataan') }}</textarea>
                        @error('pernyataan')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="strategi" class="form-control form-control-sm @error('strategi') is-invalid @enderror" id="strategi">{{ old('strategi') }}</textarea>
                        @error('strategi')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
