                    ...
                    <div class="col-lg-12">
                        <div class="card card-dark card-outline">
                            ...
                            <div class="card-body">
                                ...
                                <form action="{{ route('list1_survey_alumni') }}" method="post" autocomplete="off">
                                    @csrf
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-4 text-md-right">Tahun Tutup Studi</label>
                                        <div class="col-sm-5">
