...
@section('title', 'SI-IMUT | Mahasiswa')
@section('css')
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card card-dark card-outline">
                            ...
                            <form action="{{ route('list1_survey_mahasiswa') }}" method="post" autocomplete="off">
                                @csrf
                                <div class="card-body">
                                    <div class="callout callout-danger">
                                        <h5><i class="fas fa-warning "></i><b> Note:</b></h5>
                                        Inputan dengan tanda (<span class="text-red">*</span>) tidak boleh KOSONG!!!<p><br>
                                            <strong>isilah kuesioner sesuai dengan kondisi yang sebenarnya, data dan isian
                                                anda akan kami RAHASIAKAN!!!</strong>
                                        </p>
                                    </div>
