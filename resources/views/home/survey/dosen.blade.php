                        ...
                        <div class="card card-dark card-outline">
                            ...
                            <div class="card-body">
                                <div class="callout callout-danger">
                                    ...
                                    Inputan dengan tanda (<span class="text-red">*</span>) tidak boleh KOSONG!!!<p>
                                        <br>
                                        <strong>isilah kuesioner sesuai dengan kondisi yang sebenarnya, data dan isian anda
                                            akan kami RAHASIAKAN!!!</strong>
                                    </p>
                                </div>
                                <form action="{{ route('list1_survey_dosen') }}" method="post" autocomplete="off">
                                    @csrf
                                    <div class="form-group row">
                                        <label class="col-sm-4 text-md-right">Nomor Induk/NIDN <span>*</span></label>
                                        <div class="col-sm-5">
                                            <input type="text" name="nomor"
                                                class="form-control form-control-sm @error('nomor') is-invalid @enderror"
                                                placeholder="Nomor Induk Dosen" value="{{ old('nomor') }}" maxlength="30"
                                                required>
                                            @error('nomor')
                                    ...
                                    <div class="form-group row">
                                        <label class="col-sm-4 text-md-right">Nama Dosen <span>*</span></label>
                                        <div class="col-sm-5">
                                            <input type="text" name="nama"
                                                class="form-control form-control-sm @error('nama') is-invalid @enderror"
                                                placeholder="Nama Dosen" value="{{ old('nama') }}" required>
                                            @error('nama')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
