...
<body>
    <div class="col-md-12">
        ...
        <table style=" font-size:16px; font-weight: bold" class="no-border" cellspacing="0">
            ...
            <tr>
                <td class="no-border" style="width: 20%">Siklus</td>
                <td class="no-border" style="width: 1%">:</td>
        ...
        <table width="100%" cellspacing="0">
            <thead>
                <tr>
                    <th rowspan="2" class="text-center" style="width: 5%; text-align: top">
                        #</th>
                    <th rowspan="2" class="text-center">Informasi Jumlah Responden
                    <th class="text-center" colspan="5">Unsur Responden</th>
                </tr>
                <tr>
                    <th class="text-center" style="width: 8%">Mahasiswa</th>
                    <th class="text-center" style="width: 8%">Dosen</th>
                    <th class="text-center" style="width: 8%">Tendik</th>
                    <th class="text-center" style="width: 8%">Alumni</th>
                    <th class="text-center" style="width: 8%">Stakeholder</th>
                </tr>
            </thead>
            <tbody>
                <tr>
                    <td class="text-center">1</td>
                    <td>Jumlah Responden terhadap
                        {{ $SurveyPeriodes->kuesioner_master->monev_master->nm_monev }}
                    </td>
                    <td class="text-center" style="width: 8%">{{ $JumlahMahasiswa }}
                    </td>
                    <td class="text-center" style="width: 8%">{{ $JumlahDosen }}</td>
                    <td class="text-center" style="width: 8%">{{ $JumlahTendik }}</td>
                    <td class="text-center" style="width: 8%">{{ $JumlahAlumni }}</td>
                    <td class="text-center" style="width: 8%">{{ $JumlahMitra }}</td>
                </tr>
                <tr>
                    <td class="text-center">2</td>
                    <td>Persentase Responden terhadap
                        {{ $SurveyPeriodes->kuesioner_master->monev_master->nm_monev }}
                    </td>
        ...
        <table width="100%" cellspacing="0">
            @foreach ($ResponDetails as $ResponDetail)
                <tr>
                    <th style="text-align:left" colspan="4">{{ $loop->iteration }}. {!! strip_tags($ResponDetail->kuesioner_detail->pertanyaan) !!}</th>
                </tr>
                <tr>
