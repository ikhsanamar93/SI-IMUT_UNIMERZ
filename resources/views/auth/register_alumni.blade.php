...
@section('title', 'SI-IMUT | Registrasi Alumni')
@section('css')
                    ...
                    <div class="col-lg-12">
                        <div class="card card-dark card-outline">
                            <div class="card-header">
                                <h5 class="card-title m-0">Form Registrasi Alumni</h5>
                            </div>
                            <div class="card-body">
                                ...
                                <form action="{{ route('request_register') }}" method="post" autocomplete="off">
                                    ...
                                    <div class="form-group row mb-2">
                                        ...
                                        <div class="col-sm-5">
                                            <input type="text" name="nomor"
                                                ...
                                                placeholder="Nomor Induk Alumni" value="{{ old('nomor') }}" maxlength="30"
                                                required>
                                            @error('nomor')
                                    ...
                                    <div class="form-group row mb-2">
                                        <label class="col-sm-4 text-md-right">Nomor Ijazah <span>*</span></label>
                                        <div class="col-sm-5">
                                            <input type="text" name="nomor"
                                                class="form-control form-control-sm @error('nomor') is-invalid @enderror"
                                                placeholder="Nomor Induk Alumni" value="{{ old('nomor') }}" maxlength="30"
                                    ...
                                    <div class="form-group row mb-2">
                                        <label class="col-sm-4 text-md-right">Nama Alumni <span>*</span></label>
                                        <div class="col-sm-5">
                                            <input type="text" name="nama"
                                                class="form-control form-control-sm @error('nama') is-invalid @enderror"
                                                placeholder="Nama Alumni" value="{{ old('nama') }}" required>
                                            @error('nama')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
