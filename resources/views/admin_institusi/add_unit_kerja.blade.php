...
@section('title', 'SI-IMUT | Add Unit Kerja')
@section('css')
    ...
    <div class="col-md-12">
        <div class="card card-outline card-gray-dark">
            <div class="card-header">
                <h3 class="card-title">Add Unit Kerja</h3>
            ...
            <form class="form-horizontal" action="{{ route('save_unit_kerja') }}" method="POST"
                        ...
                        <div class="col-sm-5">
                            <select name="unit_kategori_id"
                                ...
                                @foreach ($UnitKategoris as $UnitKategori)
                                    @if (old('unit_kategori_id') == $UnitKategori->id)
                        ...
                        <div class="col-sm-5">
                            <select name="unit_pengelola_id"
                                ...
                                @foreach ($UnitPengelolas as $UnitPengelola)
                                    @if (old('unit_pengelola_id') == $UnitPengelola->id)
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <input type="text" name="nm_unit"
                                ...
                                placeholder="Nama Unit Kerja" value="{{ old('nm_unit') }}" required="">
                            @error('nm_unit')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <input type="text" name="no_unit"
                                ...
                                placeholder="Kode Unit Kerja" value="{{ old('no_unit') }}" maxlength="30">
                            @error('no_unit')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <input type="text" name="no_penetapan_unit"
                                ...
                                value="{{ old('no_penetapan_unit') }}" placeholder="Nomor Pengesahan Unit Kerja"
                                maxlength="30">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="input-group date col-sm-5" id="tgl_penetapan" data-target-input="nearest">
                            <input type="text" name="tgl_penetapan_unit"
                                ...
                                value="{{ old('tgl_penetapan_unit') }}" data-target="#tgl_penetapan" />
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-5">
                            <textarea name="ket" class="form-control form-control-sm @error('ket') is-invalid @enderror" rows="4"
                                placeholder="Deskripsi Unit Kerja ...">{{ old('ket') }}</textarea>
                            @error('ket')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
