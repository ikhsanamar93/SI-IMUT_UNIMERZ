...
class SurveyAlumniController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('home.survey.alumni', compact('UnitMasters', 'TahunMasters', 'UnitMastersF'));
    }
    ...
    {
        $data = AlumniMaster::where('nomor', decrypt($request->nomor))->first();
    ...
    public function store(Request $request)
    {
        ...
        $cari = AlumniMaster::where('nomor', $request->nomor)->first();
        if ($cari == null) {
            AlumniMaster::create(
                $validasi
            );
        ...
        $data = AlumniMaster::where('nomor', $request->nomor)->first();
        $unit_master_id = $data->unit_master_id;
        $fakultas_id = $data->fakultas_id;
        $target = '4';
